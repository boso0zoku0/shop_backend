...
from core.rabbit.connection_manager import ConnectionManager
from core.rabbit.service import SupportChatRabbitMQ
    ...
    try:
        while True:
            ...
            if message_data.get("type") == "new_request":
                ...
                await rabbitmq.send_chat_request(
                    client_id=client_id, message=message_data["text"]
                )
